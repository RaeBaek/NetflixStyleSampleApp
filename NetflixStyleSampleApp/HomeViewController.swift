...
class HomeViewController: UICollectionViewController {
    ...
    override func viewDidLoad() {
        ...
        collectionView.register(ContentCollectonViewCell.self, forCellWithReuseIdentifier: "ContentCollectionViewCell")
...
extension HomeViewController {
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        case .basic, .large:
            guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "ContentCollectionViewCell", for: indexPath) as? ContentCollectonViewCell else { return UICollectionViewCell() }
